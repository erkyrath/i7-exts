...
To say command list:
	...
	say "[br]Things which cannot be made to work in 6G60:[para]";
	say "  - Parsing defined units, such as '$1.25' or '26 kg'. The parsing routines for these are generated by I7.[br]";
